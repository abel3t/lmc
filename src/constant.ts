...
export const giftQuestions = [
  ...
  { id: 5, text: 'Tôi rất dễ nhận ra ai đó có thành thật hay không.', type: GiftType.E },
  {
    id: 6,
  ...
  { id: 12, text: 'Khi tôi phục vụ Chúa, tôi thực sự không muốn ai biết hay ghi nhận.', type: GiftType.L },
  { id: 13, text: 'Nhà của tôi luôn rộng mở cho bất kỳ ai Chúa đem đến cho chúng tôi.', type: GiftType.M },
  {
    id: 14,
  ...
  { id: 17, text: 'Tôi thấy rất thương cảm khi ai đó có vấn đề.', type: GiftType.Q },
  { id: 18, text: 'Tôi tin rằng Đức Chúa Trời có thể thay đổi hoàn cảnh một cách kỳ diệu.', type: GiftType.R },
  { id: 19, text: 'Tôi có thể liên hệ tốt với những người đến từ bối cảnh văn hóa khác nhau.', type: GiftType.S },
  {
    id: 20,
    text: 'Nhạc thánh luôn nâng tâm linh tôi lên và khiến tôi muốn ngợi khen và thờ phượng Chúa.',
    type: GiftType.T
  },
  { id: 21, text: 'Tôi có một tấm lòng muốn giúp đỡ những Cơ Đốc nhân bị lạc lối.', type: GiftType.U },
  {
    id: 22,
  ...
  { id: 32, text: 'Tôi thích làm cho người khác những món quà mà có thể nhắc họ về Chúa.', type: GiftType.D },
  {
    id: 33,
  ...
  { id: 34, text: 'Khích lệ cho những người đang nản lòng làm cho tôi vui lắm.', type: GiftType.F },
  { id: 35, text: 'Tôi đã từng hướng dẫn người khác đến quyết định tin nhận Chúa để có sự cứu rỗi.', type: GiftType.G },
  { id: 36, text: 'Tôi có thể thách thức những người khác mà không sợ người ta lên án hay bực bội.', type: GiftType.H },
  {
    id: 37,
  ...
  { id: 42, text: 'Tôi dường như có thể nhận ra sự cầu nguyện quan trọng hơn những điều khác.', type: GiftType.N },
  { id: 43, text: 'Tôi có thể hiểu những phần Lời Chúa khó hiểu trong Kinh Thánh.', type: GiftType.O },
  { id: 44, text: 'Tôi có thể phân công công việc cho những người khác để hoàn tất công việc Chúa.', type: GiftType.P },
  {
    id: 45,
  ...
  { id: 52, text: 'Người ta nói tôi có thể giúp họ nhận ra những lẽ thật Kinh Thánh.', type: GiftType.X },
  {
    id: 53,
    text: 'Đôi khi có người nói tiếng lạ, tôi hiểu được ý Chúa đang muốn nói trong tiếng lạ đó.',
    type: GiftType.Y
  },
  { id: 54, text: 'Tôi có thể nói chuyện với Chúa bằng một ngôn ngữ mà tôi chưa hề học bao giờ.', type: GiftType.Z },
  { id: 55, text: 'Đôi khi Chúa cho tôi một ý niệm về điều mà một ai đó nên làm.', type: GiftType.AA },
  {
    id: 56,
  ...
  { id: 59, text: 'Tôi rất vui vì có nhiều thời gian để hầu việc Chúa, độc thân mà.', type: GiftType.C },
  { id: 60, text: 'Tôi thích dùng tay mình làm ra những sản phẩm phục vụ Chúa.', type: GiftType.D },
  { id: 61, text: 'Tôi có thể nhận ra sự thật và dối trá rất dễ.', type: GiftType.E },
  { id: 62, text: 'Tôi có thể tích cực thúc đẩy người khác tham gia vào chức vụ.', type: GiftType.F },
  {
    id: 63,
    text: 'Tôi hình như có thể xác định được khi Đức Thánh Linh chuẩn bị lòng một ai đó để tiếp nhận Chúa Jêsus.',
    type: GiftType.G
  },
  { id: 64, text: 'Người ta có thể tin tưởng tôi được vì họ biết tôi luôn đứng về phía họ.', type: GiftType.H },
  {
    id: 65,
  ...
  { id: 68, text: 'Tôi thích làm những công việc thường lệ để giúp ích cho chức vụ hiệu quả.', type: GiftType.L },
  {
    id: 69,
  ...
  { id: 73, text: 'Tôi thích dành thời gian cho người đang đau khổ hoặc đang trong tù tội.', type: GiftType.Q },
  { id: 74, text: 'Đức Chúa Trời đã sử dụng tôi để bày tỏ những phép lạ siêu nhiên.', type: GiftType.R },
  { id: 75, text: 'Suy nghĩ về việc mở một Hội thánh mới trong một cộng đồng mới làm tôi hào hứng.', type: GiftType.S },
  {
    id: 76,
  ...
  { id: 78, text: 'Nhà to, xe đẹp, hay tài khoản nhiều tiền không quan trọng đối với tôi.', type: GiftType.V },
  {
    id: 79,
    text: 'Đôi khi tôi có một khao khát cháy bỏng muốn nói Lời Chúa mặc dù tôi biết nhiều người không đón nhận.',
    type: GiftType.W
  },
  { id: 80, text: 'Dạy lớp Kinh Thánh là một trong những việc thích thúc nhất.', type: GiftType.X },
  {
    id: 81,
  ...
  { id: 87, text: 'Tôi độc thân và tôi không có nhu cầu gì về vấn đề tình dục cả.', type: GiftType.C },
  { id: 88, text: 'Tôi có thể bày tỏ vinh quang sáng tạo của Đức Chúa Trời qua nghệ thuật.', type: GiftType.D },
  {
    id: 89,
    text: 'Tôi có thể nhận ra rõ ràng lẽ thật hay sự lừa dối sau một câu phát biểu thần học nào đó.',
    type: GiftType.E
  },
  { id: 90, text: 'Tôi tự tin, mạnh mẽ khích lệ người đang dao động, buồn khổ hay nản lòng.', type: GiftType.F },
  {
    id: 91,
  ...
  { id: 93, text: 'Tôi sẵn sàng thử những điều không thể vì tôi có một lòng tin rất lớn nơi Chúa.', type: GiftType.I },
  {
    id: 94,
  ...
  { id: 96, text: 'Tôi thích làm những công việc âm thầm hơn là những việc mà ai cũng biết đến.', type: GiftType.L },
  { id: 97, text: 'Tôi không thấy khó chịu khi ai đó tiện đường ghé thăm mà không nói trước gì cả', type: GiftType.M },
  {
    id: 98,
  ...
  { id: 104, text: 'Nhiều người nói với tôi rằng họ được cảm động khi tôi hát, múa hay chơi nhạc', type: GiftType.T },
  { id: 105, text: 'Tôi cảm nhận Chúa kêu gọi tôi làm người lãnh đạo thuộc linh của một nhóm nhỏ', type: GiftType.U },
  { id: 106, text: 'Tôi không ghen tị với ai có nhiều của cải vật chất hơn tôi', type: GiftType.V },
  {
    id: 107,
  ...
  { id: 112, text: 'Người khác nói họ được cảm động về những gì tôi viết', type: GiftType.AB },
  {
    id: 113,
  ...
  { id: 117, text: 'Tôi có thể nhanh chóng nhận ra điều một người dạy có đúng với Lời Chúa không', type: GiftType.E },
  { id: 118, text: 'Những người cảm thấy mệt mỏi đôi lúc đến với tôi để được an ủi', type: GiftType.F },
  { id: 119, text: 'Tôi thấy bực bội với những sự dạy dỗ không nhấn mạnh sự cứu rỗi', type: GiftType.G },
  {
    id: 120,
  ...
  { id: 123, text: 'Tôi đã cầu nguyện cho người bệnh và sự chữa lành thực sự đã xảy ra', type: GiftType.K },
  { id: 124, text: 'Nếu ai đó đối diện với khủng hoảng nghiêm trọng, tôi thích được giúp đỡ họ', type: GiftType.L },
  { id: 125, text: 'Khi ai đó đến nhà tôi, họ thường thấy thoải mái như ở nhà', type: GiftType.M },
  {
    id: 126,
  ...
  { id: 129, text: 'Đôi khi tôi rất cảm động và xúc cảm cho hoàn cảnh người mà tôi đang cầu nguyện', type: GiftType.Q },
  {
    id: 130,
  ...
  { id: 135, text: 'Đức Chúa Trời đã bày tỏ cho tôi những điều sẽ xảy ra trong tương lai', type: GiftType.W },
  {
    id: 136,
  ...
  { id: 138, text: 'Khi tôi cầu nguyện tiếng lạ, tôi tin rằng điều đó sẽ gây dựng nhóm của tôi', type: GiftType.Z },
  {
    id: 139,
